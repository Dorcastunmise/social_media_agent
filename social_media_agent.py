# --------------------------------------------------------------
# Step 0: Importing packages and modules
# --------------------------------------------------------------
import asyncio
import os
...
# --------------------------------------------------------------
# Step 1: Fetching OpenAI API key
# --------------------------------------------------------------
load_dotenv()
OPENAI_API_KEY = os.getenv("OPENAI_API_KEY")

# --------------------------------------------------------------
# Step 2: Defination tools for agent
# --------------------------------------------------------------
...
# Fetching transcript from a youtube video using the video id
def get_transcript(video_id: str, languages: list = None) -> str:
    ...
    try:
        ...
        # Handling specific YouTube transcript API exceptions
...
async def main():
    ...
    # Running content writer agent
    # Adding trace to see the agent's execution steps
    # trace on https://platform.openai.com/traces
