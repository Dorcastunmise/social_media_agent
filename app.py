...
with col1:
    video_id = st.text_input("YouTube Video ID", placeholder="e.g., uBmCSdiMeFk")
    st.caption("The ID is the part after 'v=' in a YouTube URL. For example, in 'https://www.youtube.com/watch?v=uBmCSdiMeFk', the ID is 'uBmCSdiMeFk'.")
